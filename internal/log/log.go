...
type Logger interface {
	...
	Error(err error, keyvals ...interface{}) error
}

// ErrMissingValue is appended to keyvals slices with odd length to substitute
// the missing value.
var ErrMissingValue = errors.New("no-value")

// TimestampFieldName is the key of the timestamp field.
var TimestampFieldName = "@time"

// LevelFieldName is the key of the level field.
var LevelFieldName = "@level"

// MessageFieldName is the key of the message field.
var MessageFieldName = "@message"

// CallerFieldName is the key of the caller field.
var CallerFieldName = "@caller"

// ErrorFieldName is the key of the error field.
var ErrorFieldName = "@error"

// ErrorStackFieldName is the key of the error stack trace field.
...
func (l *context) kvs(keyvals ...interface{}) []interface{} {
	kvs := append(l.keyvals, keyvals...)
	if len(kvs)%2 != 0 {
		kvs = append(kvs, ErrMissingValue)
	}
...
// Debug replaces all value elements (odd indexes) containing a Valuer in the
// stored context with their generated value, appends keyvals, and passes the
// result to the wrapped Logger.
func (l *context) Debug(msg string, keyvals ...interface{}) error {
	return l.logger.Debug(msg, l.kvs(keyvals...)...)
}

// Info replaces all value elements (odd indexes) containing a Valuer in the
// stored context with their generated value, appends keyvals, and passes the
// result to the wrapped Logger.
func (l *context) Info(msg string, keyvals ...interface{}) error {
	return l.logger.Info(msg, l.kvs(keyvals...)...)
}

// Warn replaces all value elements (odd indexes) containing a Valuer in the
// stored context with their generated value, appends keyvals, and passes the
// result to the wrapped Logger.
func (l *context) Warn(msg string, keyvals ...interface{}) error {
	return l.logger.Warn(msg, l.kvs(keyvals...)...)
}

// Error replaces all value elements (odd indexes) containing a Valuer in the
// stored context with their generated value, appends keyvals, and passes the
// result to the wrapped Logger.
func (l *context) Error(err error, keyvals ...interface{}) error {
	return l.logger.Error(err, l.kvs(keyvals...)...)
}
